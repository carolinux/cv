...
\item[$\bullet$] Automated uploading of payment receipts to Google Drive 
\item[$\bullet$] Productionized older code by writing tests before refactoring, CI integration and using Terraform to deploy to AWS
\end{itemize}
...
\item[$\bullet$] Built a system out of AWS components to generate personalized product recommendations
\end{itemize}
